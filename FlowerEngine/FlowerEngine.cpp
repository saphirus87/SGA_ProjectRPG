...
#include "Application\SceneLoading.h"
	...
	void* pUserContext)
{
	...
	V_RETURN(DXUTFindDXSDKMediaFileCch(str, MAX_PATH, L"FlowerEngine.fx"));
	...
	const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext)
{
	...
	// 게임 오브젝트 리셋
	for (auto & o : GameObject::m_mapGameObjects)
		o.second->ResetDevice();
...
void CALLBACK OnD3D9FrameRender(IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext)
{
	...
	if (SUCCEEDED(pd3dDevice->BeginScene()))
	{
		...
		//g_pEffect9->SetMatrix("abc", &mWorldViewProjection);
	...
	void* pUserContext)
{
	...
	*pbNoFurtherProcessing = g_SampleUI.MsgProc(hWnd, uMsg, wParam, lParam);
	...
	Input::GetInstance()->m_pMouse->InputProc(uMsg, wParam, lParam);
